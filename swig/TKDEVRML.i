...
// Definitions for wrapping Open CASCADE classes from TKDEVRML toolkit to CSharp using SWIG.
...
WRAP_AS_HANDLE_INCLUDE(DEVRML_ConfigurationNode)
WRAP_AS_HANDLE_INCLUDE(DEVRML_Provider)
